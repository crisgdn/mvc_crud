...
<div id="empDetails"> 
   <?php
	...
	<div class="gap">
	<?php	
		echo '<a href="http://localhost/cristine_pdo/index.php?task=delete&id='.$userfip[0]->id.'">delete employee</a><br>';
		echo '<a href="http://localhost/cristine_pdo/index.php?task=update&id='.$userfip[0]->id.'">update employee</a>';	
	?>
	</div>
</div>
